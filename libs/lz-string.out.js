(function(){'use strict';// Copyright (c) 2013 Pieroxy <pieroxy@pieroxy.net>
  ...
  function getBaseValue(alphabet, character) {
    if (!baseReverseDic.has(alphabet)) {
      ...
      for (var i=0 ; i<alphabet.length ; i++) {
        var alphabetValue = baseReverseDic.get(alphabet);
        alphabetValue.set(alphabet.charAt(i), i);
      }
    }
    var alphabetValue = baseReverseDic.get(alphabet);
    return alphabetValue.get(character);
  }
